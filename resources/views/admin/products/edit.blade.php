                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card mb-3" id="productPriceCard">
                            <div class="card-body">
                                ...
                                <div id="priceOptionsContainer">
                                    <div class="row price">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="priceOption"
                                                    id="priceOptionFixed" value="fixedMedia"
                                                    {{ $selectedOption == 'fixedMedia' ? 'checked' : '' }}
                                ...
                                <div id="fixedMediaContainer" class="{{ $selectedOption != 'fixedMedia' ? 'hidden' : '' }}">
                                ...
                                <button type="button" id="addFixedMediaFieldsBtn" class="btn btn-success">Add Fixed
                                    Media</button>
...
@section('customjs')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleContainers(selectedOption) {
                [rollMediaContainer, fixedMediaContainer, rigidMediaContainer].forEach(container => container.classList.add('hidden'));
                [addRollMediaFieldsBtn, addFixedMediaFieldsBtn].forEach(btn => btn.style.display = 'none');
                
                if (selectedOption === 'rollMedia') {
                    rollMediaContainer.classList.remove('hidden');
                    addRollMediaFieldsBtn.style.display = 'block';
                } else if (selectedOption === 'fixedMedia') {
            ...
            document.addEventListener('click', function(e) {
                ...
                if (e.target.classList.contains('removeFixedBtn')) e.target.closest('.fixedMediaFieldSet').remove();
                if (e.target.classList.contains('remove-price-field')) e.target.closest('.price-fields-container').remove();
                updateRemoveButtons();
            });

            function updateRemoveButtons() {
                ['rollMediaFieldSet', 'fixedMediaFieldSet'].forEach(setClass => {
    ...
    observer.observe(document.getElementById('fixedMediaContainer'), { childList: true, subtree: true });
