...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var customSizeFields = document.getElementById('customSizeFields');
        ...
        widthInput.addEventListener('blur', logCustomSizeWithDelay);
        heightInput.addEventListener('blur', logCustomSizeWithDelay);

        function logCustomSizeWithDelay() {
            setTimeout(function() {
                if (sizeDropdown.value === 'Custom Size') {
                    var width = widthInput.value;
                    var height = heightInput.value;
                    if (width && height) {
                        console.log("Custom Size - Width: " + width + "mm, Height: " + height + "mm");
                    }
                }
